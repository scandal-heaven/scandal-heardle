var app = (function() {
      ...
      m.$on("click", e[4]), {
        c() {
          ...
          Q(i.$$.fragment),
            ...
            (l = x()),
            (u = w("h1")),
            (u.textContent = "SCANDAL Heardle - Created by SCANDAL HEAVEN"),
            (c = x()),
            (d = w("div")),
            Q(h.$$.fragment),
            (f = x()),
  ...
  function Nt(t) {
    ...
    return {
      c() {
        (n = w("div")),
        (n.innerHTML =
          '<p class="mb-3">A clone of <a href="https://www.heardle.app/" title="Heardle">Heardle</a> but for SCANDAL songs. Each song is randomly chosen from their official discography.</p> \n\n<p class="mb-3">Made by <a href="https://www.scandal-heaven.com/">SCANDAL HEAVEN</a>. All copyright goes to SCANDAL, Victor Entertainment, Epic Records Japan, and other relevant parties.</p> \n\n\n\n <p class="mb-3">  </p>  \n\n\n\n <p class="text-xs mb-3 text-custom-line">Prepared with <a href="https://developers.soundcloud.com">SoundCloud</a>\n and powered by <a href="https://glitch.com/">Glitch</a>.'),
        M(n, "class", "text");
      },
      m(e, t) {
        g(e, n, t);
  ...
  function It(t) {
    ...
    return {
      c() {
        ...
        (r = w("a")),
        (r.innerHTML =
          '<span class="kofitext svelte-1d3p4dy"><img src="https://storage.ko-fi.com/cdn/cup-border.png" alt="Ko-fi donations" class="kofiimg mr-2 mb-1 svelte-1d3p4dy"/>Support SCANDAL HEAVEN</span><svg xmlns="http://www.w3.org/2000/svg" class="ml-2" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h13M12 5l7 7-7 7"></path></svg>'),
        M(
            r,
            "class",
            "kofi-button py-2 px-3 rounded-lg items-center flex  svelte-1d3p4dy"
          ),
          M(r, "href", "https://ko-fi.com/scandal_heaven"),
          M(r, "title", "Support SCANDAL HEAVEN on Ko-fi"),
          M(
            n,
            "class",
    ...
    return (
      ...
      (u = new Bt({})), {
        c() {
          ...
          (s = w("p")),
          (n.innerHTML =
            "If you like this game, please consider supporting SCANDAL HEAVEN on Ko-fi."),
          (r = x()),
          (s = w("p")),
          (i = x()),
          (o = w("div")),
      ...
      (O = new Rt({})), {
        c() {
          ...
          W.c(),
            ...
            (m = w("div")),
            (k = w("div")),
            (k.textContent = "Next SCANDAL song in:"),
            (b = x()),
            Q(S.$$.fragment),
            (D = x()),
            (T = w("div")),
  ...
  function an(e) {
    ...
    return {
      c() {
        (t = _("You got today's SCANDAL Heardle within the first ")),
        (n = _(s)),
        (r = _(" seconds."));
      },
      m(e, s) {
  ...
  function ln(e) {
    ...
    return {
      c() {
        (t = _("You got today's SCANDAL Heardle within ")),
        (n = _(o)),
        (r = _("\n                second")),
        (s = _(a)),
        (i = _("."));
  ...
  function un(t) {
    ...
    return {
      c() {
        n = _("You didn't get today's SCANDAL Heardle. Better luck tomorrow!");
      },
      m(e, t) {
        g(e, n, t);
      },
    ...
    return (
      ...
      [
        ...
        () => {
          ...
          let e = "SCANDAL Heardle - Created by SCANDAL HEAVEN #" + (s.id + 1),
            t = "";
          a
            ?
          ...
          let o =
            ...
            t +
            "\n\n" +
            "https://scandal-heardle.glitch.me/";
          if (
            !navigator.share ||
  ...
  const Cn = ue([
      "SCANDAL - 1:47",
      "SCANDAL - *~Asterisk~ (ORANGE RANGE cover)",
      "SCANDAL - 24 Jikan Plus no Yoake Mae",
      "SCANDAL - A.M.D.K.J.",
      "SCANDAL - Ai ni Naranakatta no sa",
      "SCANDAL - Ai no Shoutai",
      "SCANDAL - Aitai",
      "SCANDAL - ALONES (Aqua Timez cover)",
      "SCANDAL - Anata e",
      "SCANDAL - Anata ga Mawaru",
      "SCANDAL - Ao no Naru Yoru no Sukima de",
      "SCANDAL - Appletachi no Dengon",
      ...
      "SCANDAL - BURN",
      "SCANDAL - CANDY",
      "SCANDAL - Ceramic Blue",
      "SCANDAL - Chiisana Honoo",
      "SCANDAL - CUTE!",
      "SCANDAL - DAYDREAM (JUDY AND MARY cover)",
      "SCANDAL - Departure",
      "SCANDAL - DOLL",
      "SCANDAL - Doukashiterutte",
      "SCANDAL - Electric Girl",
      "SCANDAL - Emotion",
      "SCANDAL - eternal",
      "SCANDAL - EVERYBODY SAY YEAH!",
      "SCANDAL - Fanfare",
      "SCANDAL - Flashback No.5",
      "SCANDAL - FREEDOM FIGHTERS",
      "SCANDAL - Futari",
      "SCANDAL - FUTURE",
      "SCANDAL - Fuzzy",
      "SCANDAL - GIRLism",
      "SCANDAL - GLAMOROUS YOU",
      "SCANDAL - Graduation",
      "SCANDAL - Gunjou pleats",
      "SCANDAL - Hachigatsu",
      "SCANDAL - Happy Birthday",
      "SCANDAL - Happy Collector",
      "SCANDAL - Haruka",
      "SCANDAL - HARUKAZE",
      "SCANDAL - Heaven na Kibun",
      "SCANDAL - Hello!Hello!",
      "SCANDAL - HELLO",
      "SCANDAL - Hi-Hi-Hi",
      "SCANDAL - Hikare",
      "SCANDAL - Highlight no Naka de Bokura Zutto",
      "SCANDAL - Hitotsu Dake",
      "SCANDAL - Hon wo Yomu",
      "SCANDAL - Hoshi no Furu Yoru ni",
      "SCANDAL - Houkago 1H",
      "SCANDAL - How crazy (YUI cover)",
      "SCANDAL - I want you",
      "SCANDAL - Image",
      "SCANDAL - Ivory",
      ...
      "SCANDAL - Kagerou",
      "SCANDAL - Kan Biiru",
      "SCANDAL - Kanojo wa Wave",
      "SCANDAL - Kill the virgin",
      "SCANDAL - Kimi ni Shittochuu",
      "SCANDAL - Kimi to Mirai to Kanzen Douki",
      "SCANDAL - Kimi to Yoru to Namida",
      "SCANDAL - Kinenbi",
      "SCANDAL - Koe",
      "SCANDAL - Koi Moyou",
      "SCANDAL - Koi no Gestalt Houkai",
      "SCANDAL - Koibito ga Santa Claus (Yumi Matsutoya cover)",
      "SCANDAL - Koisuru Universe",
      "SCANDAL - Konya wa Pizza Party",
      "SCANDAL - KOSHI-TANTAN",
      "SCANDAL - Laundry Laundry",
      "SCANDAL - LIFE IS A JOURNEY",
      "SCANDAL - Line of sight",
      "SCANDAL - Living in the city",
      "SCANDAL - LOOP",
      "SCANDAL - LOVE",
      "SCANDAL - love in action",
      "SCANDAL - LOVE ME DO",
      "SCANDAL - LOVE SURVIVE",
      "SCANDAL - Mabataki",
      "SCANDAL - Maboroshi Night",
      "SCANDAL - Mado wo Aketara",
      "SCANDAL - Masterpiece",
      "SCANDAL - Metronome",
      "SCANDAL - Midnight City",
      "SCANDAL - Midnight Television",
      "SCANDAL - MIRROR",
      "SCANDAL - Morning sun",
      "SCANDAL - Nai Nai Night 2014",
      "SCANDAL - Namida no Regret",
      "SCANDAL - Namida yo Hikare",
      "SCANDAL - Natsu Neiro",
      "SCANDAL - NEON TOWN ESCAPE",
      "SCANDAL - Oh! No!",
      "SCANDAL - Oh, Pretty Woman",
      "SCANDAL - one more time",
      "SCANDAL - one piece",
      "SCANDAL - Onegai Navigation",
      "SCANDAL - Orange Juice",
      "SCANDAL - Osaka LOVER (DREAMS COME TRUE cover)",
      "SCANDAL - OSAKA",
      "SCANDAL - OVER",
      "SCANDAL - OVER DRIVE",
      "SCANDAL - Oyasumi",
      "SCANDAL - Pin Heel Surfer",
      "SCANDAL - Place of Life (feat. Tetsuya Komuro)",
      "SCANDAL - Platform Syndrome",
      "SCANDAL - Playboy",
      "SCANDAL - Playboy Part II",
      "SCANDAL - Plum",
      "SCANDAL - Pride",
      "SCANDAL - Prism",
      ...
      "SCANDAL - Rising Star",
      "SCANDAL - Rock 'n Roll Widow (Momoe Yamaguchi cover)",
      "SCANDAL - Rock'n Roll",
      "SCANDAL - Room No.7",
      "SCANDAL - Roppongi Shinjuu (Ann Lewis cover)",
      ...
      "SCANDAL - secret base ~Kimi ga Kureta Mono~ (ZONE cover)",
      "SCANDAL - Shining Sun",
      "SCANDAL - Short Short",
      "SCANDAL - Shoujo M",
      "SCANDAL - Shoujo S",
      "SCANDAL - Shunkan Sentimental",
      "SCANDAL - SINKY-YORK (Jitterin' Jinn cover)",
      "SCANDAL - Sisters",
      "SCANDAL - SO EASY",
      ...
      "SCANDAL - Sunny Day Sunday (Sentimental Bus cover)",
      "SCANDAL - Switch",
      ...
      "SCANDAL - Terra Boy",
      "SCANDAL - TOKYO",
      "SCANDAL - Tokyo Skyscraper",
      "SCANDAL - Tonight",
      "SCANDAL - Tsuki",
      "SCANDAL - Uchiagehanabi",
      "SCANDAL - Very Special",
      "SCANDAL - Vision",
      "SCANDAL - Want you",
      "SCANDAL - Watashi-tachi",
      "SCANDAL - Weather report",
      "SCANDAL - Welcome home",
      "SCANDAL - Winter story",
      "SCANDAL - Yoake no Ryuuseigun",
      "SCANDAL - YOU GO GIRL!",
      "SCANDAL - Your song",
      "SCANDAL - Your song -English ver.-",
      "SCANDAL - Yumemiru Koro wo Sugite mo (HILLBILLY BOPS cover)",
      "SCANDAL - Yumemiru Tsubasa",
      "SCANDAL - Yuugure, Tokeru",
    ]),
    On = {
      subscribe: ue(
        [
          ...
          {
            url: "https://soundcloud.com/scandalheaven/one-more-time",
            answer: "SCANDAL - one more time",
          },
          {
            url: "https://soundcloud.com/scandal-official/osaka-lover",
            answer: "SCANDAL - Osaka LOVER (DREAMS COME TRUE cover)",
          },
          {
            url: "https://soundcloud.com/scandal-official/hoshinofuruyoruni",
            answer: "SCANDAL - Hoshi no Furu Yoru ni",
          },
          {
            url: "https://soundcloud.com/scandalheaven/mirror",
            answer: "SCANDAL - MIRROR",
          },
          {
            url: "https://soundcloud.com/scandal-official/yumemiru-tsubasa",
            answer: "SCANDAL - Yumemiru Tsubasa",
          },
          {
            url: "https://soundcloud.com/scandal-official/koshitantan",
            answer: "SCANDAL - KOSHI-TANTAN",
          },
          {
            url: "https://soundcloud.com/scandalheaven/mabataki",
            answer: "SCANDAL - Mabataki",
          },
          {
            url: "https://soundcloud.com/scandal-official/hello-hello",
            answer: "SCANDAL - Hello!Hello!",
          },
          {
            url: "https://soundcloud.com/scandal-official/electric-girl",
            answer: "SCANDAL - Electric Girl",
          },
          {
            url: "https://soundcloud.com/scandalheaven/prism",
            answer: "SCANDAL - Prism",
          },
          {
            url: "https://soundcloud.com/scandal-official/osaka",
            answer: "SCANDAL - OSAKA",
          },
          {
            url: "https://soundcloud.com/scandal-official/kimini-shittochu",
            answer: "SCANDAL - Kimi ni Shittochuu",
          },
          {
            url: "https://soundcloud.com/scandalheaven/fuzzy",
            answer: "SCANDAL - Fuzzy",
          },
          {
            url: "https://soundcloud.com/scandal-official/hitotsudake",
            answer: "SCANDAL - Hitotsu Dake",
          },
          {
            url: "https://soundcloud.com/scandal-official/koisuru-universe",
            answer: "SCANDAL - Koisuru Universe",
          },
          {
            url: "https://soundcloud.com/scandal-official/uchiagehanabi",
            answer: "SCANDAL - Uchiagehanabi",
          },
          {
            url: "https://soundcloud.com/scandal-official/hello",
            answer: "SCANDAL - HELLO",
          },
          {
            url: "https://soundcloud.com/scandalheaven/neon-town-escape",
            answer: "SCANDAL - NEON TOWN ESCAPE",
          },
          {
            url: "https://soundcloud.com/scandal-official/cute",
            answer: "SCANDAL - CUTE!",
          },
          {
            url: "https://soundcloud.com/scandal-official/everybody-say-yeah",
            answer: "SCANDAL - EVERYBODY SAY YEAH!",
          },
          {
            url: "https://soundcloud.com/scandal-official/metronom",
            answer: "SCANDAL - Metronome",
          },
          {
            url: "https://soundcloud.com/scandalheaven/masterpiece",
            answer: "SCANDAL - Masterpiece",
          },
          {
            url: "https://soundcloud.com/scandal-official/sinky-york",
            answer: "SCANDAL - SINKY-YORK (Jitterin' Jinn cover)",
          },
          {
            url: "https://soundcloud.com/scandal-official/i-want-you",
            answer: "SCANDAL - I want you",
          },
          {
            url: "https://soundcloud.com/scandalheaven/tsuki",
            answer: "SCANDAL - Tsuki",
          },
          {
            url: "https://soundcloud.com/scandal-official/chiisana-honoo",
            answer: "SCANDAL - Chiisana Honoo",
          },
          {
            url: "https://soundcloud.com/scandal-official/love",
            answer: "SCANDAL - LOVE",
          },
          {
            url: "https://soundcloud.com/scandal-official/place-of-life",
            answer: "SCANDAL - Place of Life (feat. Tetsuya Komuro)",
          },
          {
            url: "https://soundcloud.com/scandalheaven/amdkj",
            answer: "SCANDAL - A.M.D.K.J.",
          },
          {
            url: "https://soundcloud.com/scandal-official/room-no-7",
            answer: "SCANDAL - Room No.7",
          },
          {
            url: "https://soundcloud.com/scandal-official/shoujyo-s-1",
            answer: "SCANDAL - Shoujo S",
          },
          {
            url: "https://soundcloud.com/scandal-official/konyawa-pizza-party",
            answer: "SCANDAL - Konya wa Pizza Party",
          },
          {
            url: "https://soundcloud.com/scandalheaven/tonight",
            answer: "SCANDAL - Tonight",
          },
          {
            url: "https://soundcloud.com/scandal-official/suki-suki",
            answer: "SCANDAL - SUKI-SUKI",
          },
          {
            url: "https://soundcloud.com/scandal-official/love-me-do",
            answer: "SCANDAL - LOVE ME DO",
          },
          {
            url: "https://soundcloud.com/scandal-official/koe",
            answer: "SCANDAL - Koe",
          },
          {
            url: "https://soundcloud.com/scandal-official/want-you",
            answer: "SCANDAL - Want you",
          },
          {
            url: "https://soundcloud.com/scandal-official/over",
            answer: "SCANDAL - OVER",
          },
          {
            url: "https://soundcloud.com/scandal-official/sisters",
            answer: "SCANDAL - Sisters",
          },
          {
            url: "https://soundcloud.com/scandalheaven/cb-1",
            answer: "SCANDAL - Ceramic Blue",
          },
          {
            url: "https://soundcloud.com/scandal-official/happy-collector",
            answer: "SCANDAL - Happy Collector",
          },
          {
            url: "https://soundcloud.com/scandal-official/pride",
            answer: "SCANDAL - Pride",
          },
          {
            url: "https://soundcloud.com/scandal-official/madowoaketara",
            answer: "SCANDAL - Mado wo Aketara",
          },
          {
            url: "https://soundcloud.com/scandal-official/stamp",
            answer: "SCANDAL - Stamp!",
          },
          {
            url: "https://soundcloud.com/scandal-official/standard",
            answer: "SCANDAL - STANDARD",
          },
          {
            url: "https://soundcloud.com/scandal-official/koimoyou",
            answer: "SCANDAL - Koi Moyou",
          },
          {
            url: "https://soundcloud.com/scandal-official/hokago-1h",
            answer: "SCANDAL - Houkago 1H",
          },
          {
            url: "https://soundcloud.com/scandal-official/onegai-nabigeshon",
            answer: "SCANDAL - Onegai Navigation",
          },
          {
            url: "https://soundcloud.com/scandalheaven/living-in-the-city",
            answer: "SCANDAL - Living in the city",
          },
          {
            url: "https://soundcloud.com/scandal-official/satisfaction",
            answer: "SCANDAL - Satisfaction",
          },
          {
            url: "https://soundcloud.com/scandal-official/over-drive",
            answer: "SCANDAL - OVER DRIVE",
          },
          {
            url: "https://soundcloud.com/scandalheaven/kanojo-wa-wave",
            answer: "SCANDAL - Kanojo wa Wave",
          },
          {
            url: "https://soundcloud.com/scandal-official/winter-story",
            answer: "SCANDAL - Winter story",
          },
          {
            url: "https://soundcloud.com/scandal-official/rockn-roll",
            answer: "SCANDAL - Rock'n Roll",
          },
          {
            url: "https://soundcloud.com/scandal-official/tokyo-skyscraper",
            answer: "SCANDAL - Tokyo Skyscraper",
          },
          {
            url: "https://soundcloud.com/scandalheaven/yuugure-tokeru",
            answer: "SCANDAL - Yuugure, Tokeru",
          },
          {
            url: "https://soundcloud.com/scandal-official/flashback-no-5",
            answer: "SCANDAL - Flashback No.5",
          },
          {
            url: "https://soundcloud.com/scandal-official/nai-nai-night-2014",
            answer: "SCANDAL - Nai Nai Night 2014",
          },
          {
            url: "https://soundcloud.com/scandal-official/koi-no-gestalt-houkai",
            answer: "SCANDAL - Koi no Gestalt Houkai",
          },
          {
            url: "https://soundcloud.com/scandal-official/hi-hi-hi",
            answer: "SCANDAL - Hi-Hi-Hi",
          },
          {
            url: "https://soundcloud.com/scandal-official/bitter-chocolate",
            answer: "SCANDAL - Bitter Chocolate",
          },
          {
            url: "https://soundcloud.com/scandal-official/august",
            answer: "SCANDAL - Hachigatsu",
          },
          {
            url: "https://soundcloud.com/scandalheaven/kinenbi",
            answer: "SCANDAL - Kinenbi",
          },
          {
            url: "https://soundcloud.com/scandal-official/taiyou-scandalous",
            answer: "SCANDAL - Taiyou Scandalous",
          },
          {
            url: "https://soundcloud.com/scandalheaven/ai-no-shoutai",
            answer: "SCANDAL - Ai no Shoutai",
          },
          {
            url: "https://soundcloud.com/scandal-official/platform-syndrome",
            answer: "SCANDAL - Platform Syndrome",
          },
          {
            url: "https://soundcloud.com/scandal-official/image",
            answer: "SCANDAL - Image",
          },
          {
            url: "https://soundcloud.com/scandal-official/kagen-no-tsuki",
            answer: "SCANDAL - Kagen no Tsuki",
          },
          {
            url: "https://soundcloud.com/scandal-official/right-here",
            answer: "SCANDAL - Right Here",
          },
          {
            url: "https://soundcloud.com/scandal-official/play-boy-part2",
            answer: "SCANDAL - Playboy Part II",
          },
          {
            url: "https://soundcloud.com/scandal-official/your-song",
            answer: "SCANDAL - Your song",
          },
          {
            url: "https://soundcloud.com/scandal-official/koibito-ga-santa-claus",
            answer: "SCANDAL - Koibito ga Santa Claus (Yumi Matsutoya cover)",
          },
          {
            url: "https://soundcloud.com/scandal-official/aitai",
            answer: "SCANDAL - Aitai",
          },
          {
            url: "https://soundcloud.com/scandal-official/natsuneiro",
            answer: "SCANDAL - Natsu Neiro",
          },
          {
            url: "https://soundcloud.com/scandal-official/departure",
            answer: "SCANDAL - Departure",
          },
          {
            url: "https://soundcloud.com/scandal-official/oh-no",
            answer: "SCANDAL - Oh! No!",
          },
          {
            url: "https://soundcloud.com/scandal-official/apple-tachinodengon",
            answer: "SCANDAL - Appletachi no Dengon",
          },
          {
            url: "https://soundcloud.com/scandal-official/runners-high",
            answer: "SCANDAL - Runners high",
          },
          {
            url: "https://soundcloud.com/scandal-official/orange-juice",
            answer: "SCANDAL - Orange Juice",
          },
          {
            url: "https://soundcloud.com/scandal-official/glamorous-you",
            answer: "SCANDAL - GLAMOROUS YOU",
          },
          {
            url: "https://soundcloud.com/scandal-official/kimi-to-yoru-to-namida-1",
            answer: "SCANDAL - Kimi to Yoru to Namida",
          },
          {
            url: "https://soundcloud.com/scandal-official/oyasumi",
            answer: "SCANDAL - Oyasumi",
          },
          {
            url: "https://soundcloud.com/scandal-official/graduation",
            answer: "SCANDAL - Graduation",
          },
          {
            url: "https://soundcloud.com/scandal-official/namidayohikare",
            answer: "SCANDAL - Namida yo Hikare",
          },
          {
            url: "https://soundcloud.com/scandal-official/scandal-in-the-house",
            answer: "SCANDAL - SCANDAL IN THE HOUSE",
          },
          {
            url: "https://soundcloud.com/scandal-official/futari",
            answer: "SCANDAL - Futari",
          },
          {
            url: "https://soundcloud.com/scandal-official/shining-sun",
            answer: "SCANDAL - Shining Sun",
          },
          {
            url: "https://soundcloud.com/scandal-official/space-ranger",
            answer: "SCANDAL - Space Ranger",
          },
          {
            url: "https://soundcloud.com/scandal-official/kimi-to-mirai-to-kanzen-douki",
            answer: "SCANDAL - Kimi to Mirai to Kanzen Douki",
          },
          {
            url: "https://soundcloud.com/scandal-official/queens-are-trumps",
            answer: "SCANDAL - Queens are trumps",
          },
          {
            url: "https://soundcloud.com/scandal-official/24-hours-plus-no-yoakemae",
            answer: "SCANDAL - 24 Jikan Plus no Yoake Mae",
          },
          {
            url: "https://soundcloud.com/scandalheaven/ao-no-naru-yoru-no-sukima-de",
            answer: "SCANDAL - Ao no Naru Yoru no Sukima de",
          },
          {
            url: "https://soundcloud.com/scandal-official/play-boy",
            answer: "SCANDAL - Playboy",
          },
          {
            url: "https://soundcloud.com/scandal-official/happy-birthday",
            answer: "SCANDAL - Happy Birthday",
          },
          {
            url: "https://soundcloud.com/scandal-official/sayonara-my-friend",
            answer: "SCANDAL - Sayonara My Friend",
          },
          {
            url: "https://soundcloud.com/scandal-official/weather-report",
            answer: "SCANDAL - Weather report",
          },
          {
            url: "https://soundcloud.com/scandalheaven/ai-ni-naranakatta-no-sa",
            answer: "SCANDAL - Ai ni Naranakatta no sa",
          },
          {
            url: "https://soundcloud.com/scandalheaven/spice",
            answer: "SCANDAL - SPICE",
          },
          {
            url: "https://soundcloud.com/scandal-official/scandal-baby",
            answer: "SCANDAL - SCANDAL BABY",
          },
          {
            url: "https://soundcloud.com/scandal-official/love-survive",
            answer: "SCANDAL - LOVE SURVIVE",
          },
          {
            url: "https://soundcloud.com/scandal-official/secret-base-kimigakuretamono",
            answer: "SCANDAL - secret base ~Kimi ga Kureta Mono~ (ZONE cover)",
          },
          {
            url: "https://soundcloud.com/scandalheaven/eternal",
            answer: "SCANDAL - eternal",
          },
          {
            url: "https://soundcloud.com/scandal-official/switch",
            answer: "SCANDAL - Switch",
          },
          {
            url: "https://soundcloud.com/scandal-official/rising-star",
            answer: "SCANDAL - Rising Star",
          },
          {
            url: "https://soundcloud.com/scandal-official/theme-of-scandal",
            answer: "SCANDAL - SCANDAL no Theme",
          },
          {
            url: "https://soundcloud.com/scandal-official/yoake-no-ryuseigun",
            answer: "SCANDAL - Yoake no Ryuuseigun",
          },
          {
            url: "https://soundcloud.com/scandal-official/rainy",
            answer: "SCANDAL - Rainy",
          },
          {
            url: "https://soundcloud.com/scandal-official/harukaze",
            answer: "SCANDAL - HARUKAZE",
          },
          {
            url: "https://soundcloud.com/scandal-official/tokyo",
            answer: "SCANDAL - TOKYO",
          },
          {
            url: "https://soundcloud.com/scandal-official/midnight-city",
            answer: "SCANDAL - Midnight City",
          },
          {
            url: "https://soundcloud.com/scandal-official/asterisk",
            answer: "SCANDAL - *~Asterisk~ (ORANGE RANGE cover)",
          },
          {
            url: "https://soundcloud.com/scandal-official/very-special",
            answer: "SCANDAL - Very Special",
          },
          {
            url: "https://soundcloud.com/scandal-official/kan-biiru",
            answer: "SCANDAL - Kan Biiru",
          },
          {
            url: "https://soundcloud.com/scandal-official/pinheel-surfer",
            answer: "SCANDAL - Pin Heel Surfer",
          },
          {
            url: "https://soundcloud.com/scandal-official/beauteen",
            answer: "SCANDAL - BEAUTeen!!",
          },
          {
            url: "https://soundcloud.com/scandal-official/sonotoki-sekaiwa-kimidarakeno",
            answer: "SCANDAL - Sono Toki, Sekai wa Kimi Darake no Rain",
          },
          {
            url: "https://soundcloud.com/scandal-official/kill-the-virgin",
            answer: "SCANDAL - Kill the virgin",
          },
          {
            url: "https://soundcloud.com/scandal-official/bright",
            answer: "SCANDAL - Bright",
          },
          {
            url: "https://soundcloud.com/scandal-official/one-piece",
            answer: "SCANDAL - one piece",
          },
          {
            url: "https://soundcloud.com/scandal-official/sunny-day-sunday",
            answer: "SCANDAL - Sunny Day Sunday (Sentimental Bus cover)",
          },
          {
            url: "https://soundcloud.com/scandal-official/your-song-english-version",
            answer: "SCANDAL - Your song -English ver.-",
          },
          {
            url: "https://soundcloud.com/scandal-official/hikare",
            answer: "SCANDAL - Hikare",
          },
          {
            url: "https://soundcloud.com/scandal-official/haruka",
            answer: "SCANDAL - Haruka",
          },
          {
            url: "https://soundcloud.com/scandalheaven/ivory",
            answer: "SCANDAL - Ivory",
          },
          {
            url: "https://soundcloud.com/scandal-official/emotion",
            answer: "SCANDAL - Emotion",
          },
          {
            url: "https://soundcloud.com/scandal-official/scandal-nanka-buttobase",
            answer: "SCANDAL - Scandal Nanka Buttobase",
          },
          {
            url: "https://soundcloud.com/scandal-official/girlism",
            answer: "SCANDAL - GIRLism",
          },
          {
            url: "https://soundcloud.com/scandal-official/rock-n-roll-widow",
            answer: "SCANDAL - Rock 'n Roll Widow (Momoe Yamaguchi cover)",
          },
          {
            url: "https://soundcloud.com/scandal-official/take-me-out",
            answer: "SCANDAL - Take Me Out",
          },
          {
            url: "https://soundcloud.com/scandal-official/shojo-m",
            answer: "SCANDAL - Shoujo M",
          },
          {
            url: "https://soundcloud.com/scandal-official/namida-no-regret",
            answer: "SCANDAL - Namida no Regret",
          },
          {
            url: "https://soundcloud.com/scandal-official/maboroshi-night",
            answer: "SCANDAL - Maboroshi Night",
          },
          {
            url: "https://soundcloud.com/scandal-official/taiyo-to-kimi-ga-egaku-story",
            answer: "SCANDAL - Taiyou to Kimi ga Egaku STORY",
          },
          {
            url: "https://soundcloud.com/scandal-official/shunkan-sentimental",
            answer: "SCANDAL - Shunkan Sentimental",
          },
          {
            url: "https://soundcloud.com/scandal-official/yumemirukorowosugitemo",
            answer: "SCANDAL - Yumemiru Koro wo Sugite mo (HILLBILLY BOPS cover)",
          },
          {
            url: "https://soundcloud.com/scandal-official/ring-ring-ring",
            answer: "SCANDAL - Ring!Ring!Ring!",
          },
          {
            url: "https://soundcloud.com/scandal-official/anata-ga-mawaru",
            answer: "SCANDAL - Anata ga Mawaru",
          },
          {
            url: "https://soundcloud.com/scandal-official/sunday-drive",
            answer: "SCANDAL - Sunday Drive",
          },
          {
            url: "https://soundcloud.com/scandal-official/sakura-good-bye",
            answer: "SCANDAL - SAKURA Goodbye",
          },
          {
            url: "https://soundcloud.com/scandal-official/freedom-fighters",
            answer: "SCANDAL - FREEDOM FIGHTERS",
          },
          {
            url: "https://soundcloud.com/scandal-official/doll",
            answer: "SCANDAL - DOLL",
          },
          {
            url: "https://soundcloud.com/scandal-official/how-crazy",
            answer: "SCANDAL - How crazy (YUI cover)",
          },
          {
            url: "https://soundcloud.com/scandal-official/kagerou",
            answer: "SCANDAL - Kagerou",
          },
          {
            url: "https://soundcloud.com/scandal-official/welcome-home",
            answer: "SCANDAL - Welcome home",
          },
          {
            url: "https://soundcloud.com/scandal-official/short-short",
            answer: "SCANDAL - Short Short",
          },
          {
            url: "https://soundcloud.com/scandal-official/honn-wo-yomu",
            answer: "SCANDAL - Hon wo Yomu",
          },
          {
            url: "https://soundcloud.com/scandal-official/awanaitsumorino-genkidene",
            answer: "SCANDAL - Awanai Tsumori no, Genki de ne",
          },
          {
            url: "https://soundcloud.com/scandal-official/daydream",
            answer: "SCANDAL - DAYDREAM (JUDY AND MARY cover)",
          },
          {
            url: "https://soundcloud.com/scandal-official/so-easy",
            answer: "SCANDAL - SO EASY",
          },
          {
            url: "https://soundcloud.com/scandal-official/life-is-a-journey",
            answer: "SCANDAL - LIFE IS A JOURNEY",
          },
          {
            url: "https://soundcloud.com/scandal-official/future",
            answer: "SCANDAL - FUTURE",
          },
          {
            url: "https://soundcloud.com/scandal-official/s-l-magic",
            answer: "SCANDAL - S.L. Magic",
          },
          {
            url: "https://soundcloud.com/scandal-official/alones",
            answer: "SCANDAL - ALONES (Aqua Timez cover)",
          },
          {
            url: "https://soundcloud.com/scandalheaven/laundry-laundry",
            answer: "SCANDAL - Laundry Laundry",
          },
          {
            url: "https://soundcloud.com/scandal-official/brand-new-wave",
            answer: "SCANDAL - Brand new wave",
          },
          {
            url: "https://soundcloud.com/scandal-official/sparkling",
            answer: "SCANDAL - Sparkling",
          },
          {
            url: "https://soundcloud.com/scandal-official/love-in-action",
            answer: "SCANDAL - love in action",
          },
          {
            url: "https://soundcloud.com/scandal-official/morning-sun",
            answer: "SCANDAL - Morning sun",
          },
          {
            url: "https://soundcloud.com/scandal-official/burn",
            answer: "SCANDAL - BURN",
          },
          {
            url: "https://soundcloud.com/scandal-official/roppongi-shinju",
            answer: "SCANDAL - Roppongi Shinjuu (Ann Lewis cover)",
          },
          {
            url: "https://soundcloud.com/scandalheaven/you-go-girl",
            answer: "SCANDAL - YOU GO GIRL!",
          },
          {
            url: "https://soundcloud.com/scandal-official/midnight-television",
            answer: "SCANDAL - Midnight Television",
          },
          {
            url: "https://soundcloud.com/scandal-official/heaven-na-kibun",
            answer: "SCANDAL - Heaven na Kibun",
          },
          {
            url: "https://soundcloud.com/scandalheaven/m-1",
            answer: "SCANDAL - MIRROR",
          },
          {
            url: "https://soundcloud.com/scandal-official/midnight-city",
          ...
          {
            url: "https://soundcloud.com/scandalheaven/line-of-sight",
            answer: "SCANDAL - Line of sight",
          },
          {
            url: "https://soundcloud.com/scandal-official/rock-n-roll-widow",
            answer: "SCANDAL - Rock 'n Roll Widow (Momoe Yamaguchi cover)",
          ...
          {
            url: "https://soundcloud.com/scandalheaven/vision",
            answer: "SCANDAL - Vision",
          },
          {
            url: "https://soundcloud.com/scandalheaven/spice",
            answer: "SCANDAL - SPICE",
          ...
          {
            url: "https://soundcloud.com/scandalheaven/highlight-no-naka-de-bokura-zutto",
            answer: "SCANDAL - Highlight no Naka de Bokura Zutto",
          },
          {
            url: "https://soundcloud.com/scandalheaven/candy",
            answer: "SCANDAL - CANDY",
          },          
          {
            url: "https://soundcloud.com/scandal-official/how-crazy",
            answer: "SCANDAL - How crazy (YUI cover)",
          ...
          {
            url: "https://soundcloud.com/scandalheaven/fanfare",
            answer: "SCANDAL - Fanfare",
          },          
          {
            url: "https://soundcloud.com/scandal-official/one-piece",
            answer: "SCANDAL - one piece",
          ...
          {
            url: "https://soundcloud.com/scandalheaven/anata-e",
            answer: "SCANDAL - Anata e",
          },          
          {
            url: "https://soundcloud.com/scandal-official/emotion",
            answer: "SCANDAL - Emotion",
          ...
          {
            url: "https://soundcloud.com/scandalheaven/147a",
            answer: "SCANDAL - 1:47",
          },          
          {
            url: "https://soundcloud.com/scandal-official/hello-hello",
          ...
          {
            url: "https://soundcloud.com/scandalheaven/plum",
            answer: "SCANDAL - Plum",
          },          
          {
            url: "https://soundcloud.com/scandal-official/futari",
          ...
          {
            url: "https://soundcloud.com/scandalheaven/gunjou-pleats",
            answer: "SCANDAL - Gunjou pleats",
          },          
          {
            url: "https://soundcloud.com/scandal-official/koi-no-gestalt-houkai",
            answer: "SCANDAL - Koi no Gestalt Houkai",
          ...
          {
            url: "https://soundcloud.com/scandalheaven/watashi-tachi",
            answer: "SCANDAL - Watashi-tachi",
          },          
          {
            url: "https://soundcloud.com/scandal-official/koimoyou",
            answer: "SCANDAL - Koi Moyou",
          ...
          {
            url: "https://soundcloud.com/scandalheaven/loop",
            answer: "SCANDAL - LOOP",
          },          
          {
            url: "https://soundcloud.com/scandal-official/bitter-chocolate",
          ...
          },
         {
          ...
          {
            url: "https://soundcloud.com/scandalheaven/terra-boy",
            answer: "SCANDAL - Terra Boy",
          },
          {
            url: "https://soundcloud.com/scandal-official/yoake-no-ryuseigun",
            answer: "SCANDAL - Yoake no Ryuuseigun",
          ...
          {
            url: "https://soundcloud.com/scandalheaven/doukashiterutte",
            answer: "SCANDAL - Doukashiterutte",
          },
          {
            url: "https://soundcloud.com/scandalheaven/cb-1",
            answer: "SCANDAL - Ceramic Blue",
          ...
          },
         {
          ...
          {
            url: "https://soundcloud.com/scandalheaven/soundly",
            answer: "SCANDAL - Soundly",
          },
          {
            url: "https://soundcloud.com/scandal-official/i-want-you",
            answer: "SCANDAL - I want you",
          ...
          {
            url: "https://soundcloud.com/scandalheaven/oh-pretty-woman",
            answer: "SCANDAL - Oh, Pretty Woman",
          },
          {
            url: "https://soundcloud.com/scandal-official/taiyo-to-kimi-ga-egaku-story",
            answer: "SCANDAL - Taiyou to Kimi ga Egaku STORY",
    ...
    return {
      c() {
        ...
        Q(l.$$.fragment),
          ...
          (C = x()),
          H && H.c(),
          (An.title = "SCANDAL Heardle - Created by SCANDAL HEAVEN"),
          M(t, "name", "description"),
          M(
            t,
            "content",
            "Guess the SCANDAL song from the intro in as few tries as possible"
          ),
